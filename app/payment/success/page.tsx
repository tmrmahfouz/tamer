...
export default function PaymentSuccessPage() {
  ...
  const loadPayment = async (paymentId: string) => {
    try {
      // TODO: Implement payment details API
        ...
        <div className="container mx-auto max-w-2xl">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-8">
              شكراً لك! تم تسجيلك في الدورة بنجاح
            </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-gray-900">
                      {payment.method === 'vodafone-cash' && 'فودافون كاش'}
                      {payment.method === 'instapay' && 'انستا باي'}
                      {payment.method === 'fawry' && 'فوري'}
                    </span>
                  </div>
                  <div className="flex justify-between">
            ...
            {/* Info */}
            <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg text-right">
              <p className="text-sm text-blue-800">
                <strong>ملاحظة:</strong> تم إرسال إيصال الدفع إلى بريدك الإلكتروني. يمكنك الآن الوصول إلى جميع دروس الدورة.
              </p>
            </div>
          </div>
        </div>
