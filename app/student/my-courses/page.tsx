...
export default function MyCoursesPage() {
  ...
  const filteredEnrollments = enrollments.filter((enrollment) => {
    ...
    if (searchTerm) {
      return enrollment.course.title.toLowerCase().includes(searchTerm.toLowerCase())
    }
          ...
          {enrollments.length === 0 ? (
            ...
            <>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">شهادات مكتسبة</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {filteredEnrollments.length === 0 ? (
                <div className="bg-white rounded-xl shadow-lg p-12 text-center">
                  <p className="text-gray-600">لا توجد دورات تطابق البحث</p>
                </div>
              ) : (
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-600 mb-4">
                          <div className="flex items-center gap-1">
                            ...
                            <span>{enrollment.course.lessons} درس</span>
                          </div>
                          <div className="flex items-center gap-1">
                        ...
                        <div className="flex gap-2">
                          <button
                            onClick={() => {
                              // Go to course page which will redirect to first lesson
                          ...
                          {/* زر الحصول على الشهادة عند الإكمال */}
                          {enrollment.completionPercentage === 100 && 
                           !enrollment.certificateIssued && 
                           enrollment.course.certificateEnabled !== false && (
                            <button
                              onClick={async () => {
                                try {
                              ...
                              className="px-4 py-2 bg-yellow-50 text-yellow-600 rounded-lg hover:bg-yellow-100 transition-colors font-semibold flex items-center gap-1"
                              title="الحصول على الشهادة"
                            >
                              <Award className="w-5 h-5" />
                              <span className="text-sm">شهادة</span>
                            </button>
                          )}
                        </div>
                      </div>
